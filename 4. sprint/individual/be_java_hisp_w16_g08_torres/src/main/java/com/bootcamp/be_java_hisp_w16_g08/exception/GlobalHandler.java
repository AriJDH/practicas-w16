...
import com.bootcamp.be_java_hisp_w16_g08.dto.response.ExceptionApiDto;
...
public class GlobalHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<ResponseApiDto> catchNonePromoException(NonePromoException e){
        ResponseApiDto exceptionDto = new ResponseApiDto(e.getMessage());
