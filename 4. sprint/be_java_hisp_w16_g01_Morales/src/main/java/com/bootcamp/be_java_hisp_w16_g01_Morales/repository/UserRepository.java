...
public class UserRepository implements IUserRepository {
    ...
    private void LoadData(){
        ...
        User user1= new User(1, "Vendedor1", new ArrayList<>(), new ArrayList<>(),new ArrayList<>(),new ArrayList<>());
        User user2= new User(2, "Vendedor2", new ArrayList<>(), new ArrayList<>(),new ArrayList<>(),new ArrayList<>());
        User user3= new User(3, "Usuario3", new ArrayList<>(), new ArrayList<>(),new ArrayList<>(),new ArrayList<>());
        User user4= new User(4, "Usuario4", new ArrayList<>(), new ArrayList<>(),new ArrayList<>(),new ArrayList<>());
        User user5= new User(5, "Vendedor5", new ArrayList<>(), new ArrayList<>(),new ArrayList<>(),new ArrayList<>());
