...
public class SocialMeliController {
    ...
    public ResponseEntity<PromoPostCountDto> getPromoPostVendor(@RequestParam Integer user_id){
        return new ResponseEntity<>(postService.getPromoPostCount(user_id), HttpStatus.OK);
    }

    @GetMapping("/products/promo-post/list")
    public ResponseEntity<PromoPostListDto> getPromoPostList(@RequestParam Integer user_id){
