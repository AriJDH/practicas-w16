...
public class GlobalHandler {
  ...
  @ExceptionHandler(ProductIlegalPromotion.class)
  public ResponseEntity<ProductPromotionDTO> catchExeption(ProductIlegalPromotion e) {
    ProductPromotionDTO productPromotionDTO = new ProductPromotionDTO(e.getMessage());
    return new ResponseEntity<>(productPromotionDTO, HttpStatus.BAD_REQUEST);
  }
