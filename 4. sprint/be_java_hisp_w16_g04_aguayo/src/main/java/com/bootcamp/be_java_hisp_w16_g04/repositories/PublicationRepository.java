...
public class PublicationRepository implements IPublicationRepository {
  ...
  private void loadData() {
    ...
    publications.add(new Publication(1, 104, date1, 100, 100, 150.0, true, 0.0));
    publications.add(new Publication(2, 104, date2, 200, 200, 350.0, true, 0.0));
    publications.add(new Publication(2, 104, date3, 300, 200, 350.0, true, 0.0));
  }
