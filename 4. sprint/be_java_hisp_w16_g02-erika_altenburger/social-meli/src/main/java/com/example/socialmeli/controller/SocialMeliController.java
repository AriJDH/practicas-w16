...
public class SocialMeliController {
    ...
    public ResponseEntity<PromoPostCountDto> getPromoPostCountByUserId(@RequestParam Integer user_id){
    ...
    public ResponseEntity<Void> addPromoPost(@RequestBody PromoPostDto post){
        postService.addPromoPost(post);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @GetMapping("/products/promo-post/list")
    public ResponseEntity<UserListPromoPostDto> getUserListPromoPost(@RequestParam Integer user_id){
        return new ResponseEntity<>(postService.getListUserPromoPost(user_id), HttpStatus.OK);
    }
