...
public class PostController {
    ...
    public ResponseEntity<MessageDto> createPromoPost(@RequestBody PostDto postDTO) {
        return new ResponseEntity<>(postService.createPost(postDTO), HttpStatus.OK);
    }
    ...
    public ResponseEntity<PromoCountDTO> getPromoCount(@RequestParam int user_id){
        return new ResponseEntity<>(postService.getCantPromo(user_id), HttpStatus.OK);
    }

    @GetMapping("/promo-post/list")
    public ResponseEntity<PromoPostDTO> getPromoList(@RequestParam int user_id){
        return new ResponseEntity<>(postService.getPromoList(user_id), HttpStatus.OK);
    }
