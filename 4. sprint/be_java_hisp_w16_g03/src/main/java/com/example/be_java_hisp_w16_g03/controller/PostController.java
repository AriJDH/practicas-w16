...
public class PostController {
    ...
    public ResponseEntity<PostDTO> addPromoPost(@RequestBody PromoPostDTO request) {
        service.addPromoPost(request);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @GetMapping("/products/promo-post/count")
    public ResponseEntity<PromoCountDTO> countSellerPromoPost(@RequestParam Integer user_id) {
        return new ResponseEntity<>(service.countSellerPromoPost(user_id), HttpStatus.OK);

    }

    @GetMapping("/products/promo-post/list")
    public ResponseEntity<UserPost> getSellerPostPromo(@RequestParam Integer user_id) {
        return new ResponseEntity<>(service.getSellerPostPromo(user_id), HttpStatus.OK);
