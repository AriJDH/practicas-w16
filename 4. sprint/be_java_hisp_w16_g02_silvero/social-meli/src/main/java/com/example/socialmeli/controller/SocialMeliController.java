...
public class SocialMeliController {
    ...
    public ResponseEntity<Void> addPostPromo(@RequestBody PostPromoDto postPromo){
        postService.addPostPromo(postPromo);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @GetMapping("/products/promo-post/count")
    public ResponseEntity<PostPromoCountDto> getPostCountByPromo(@RequestParam Integer user_id){
        return new ResponseEntity<>(postService.getPostPromoCount(user_id),HttpStatus.OK);
    }
    @GetMapping("/products/promo-post/list")
    public ResponseEntity<PostPromoListDto> getPostPromoList(@RequestParam Integer user_id){
        return new ResponseEntity<>(postService.getPostPromoList(user_id),HttpStatus.OK);
    }
}
