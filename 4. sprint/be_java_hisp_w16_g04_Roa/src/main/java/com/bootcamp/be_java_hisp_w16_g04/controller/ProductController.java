...
public class ProductController {
  ...
  public ResponseEntity<ResponseApiDTO> GetPublicationHasPromo(@RequestBody RequestCreatePublicationDTO requestCreatePublicationDTO){
    return new ResponseEntity<>(iProductService.CreateProduct(requestCreatePublicationDTO), HttpStatus.OK);
  }
}
