...
public class PublicationRepository implements IPublicationRepository {
  ...
  private void loadData() {
    ...
    publications.add(new Publication(1, 104, date1, 100, 100, 150.0,true,0.02));
    publications.add(new Publication(2, 104, date2, 200, 200, 350.0,false,0.025));
    publications.add(new Publication(2, 104, date3, 300, 200, 350.0,true,0.3));
  }
  ...
  private Boolean validateFields(PublicationDTO publicationDTO) {
    ...
    return publicationDTO.getUserId() != null &&
        ...
        publicationDTO.getHasPromo() != null &&
        publicationDTO.getDiscount() != null;
