...
public class Mapper {
    ...
    public static Post parseToPost(PromoPostReqDTO promoPostReqDTO) {
        return Post.builder()
                .date(promoPostReqDTO.getDate())
                .userId(promoPostReqDTO.getUserId())
                .product(parseToProduct(promoPostReqDTO.getProduct()))
                .category(promoPostReqDTO.getCategory())
                .price(promoPostReqDTO.getPrice())
                .discount(promoPostReqDTO.getDiscount())
                .hasPromo(promoPostReqDTO.getHasPromo())
                .build();
    }

    public static PromoCountResDTO parseToPromoCountResDTO(User user, List<Post> promoPosts ) {
        return PromoCountResDTO.builder()
                .userId(user.getId())
                .userName(user.getUserName())
                .promosCount(promoPosts.size())
                .build();
    }
}
