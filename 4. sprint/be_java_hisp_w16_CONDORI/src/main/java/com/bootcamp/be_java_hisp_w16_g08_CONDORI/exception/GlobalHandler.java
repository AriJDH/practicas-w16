...
import com.bootcamp.be_java_hisp_w16_g08_CONDORI.dto.response.ResponseApiDto;
...
public class GlobalHandler {
    ...
    @ExceptionHandler(PostPromotionWithoutDiscount.class)
    public  ResponseEntity<ResponseApiDto> catchPostPromotionWithoutDiscount(PostPromotionWithoutDiscount e){
        ResponseApiDto exceptionApiDto = new ResponseApiDto("The promotion has value not expected");
        return  new ResponseEntity<>(exceptionApiDto,HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(UserHasNotPostPromotionException.class)
    public  ResponseEntity<ResponseApiDto> catchUserHasNotPostPromotionException(UserHasNotPostPromotionException e){
        ResponseApiDto exceptionApiDto = new ResponseApiDto(e.getMessage());
        return  new ResponseEntity<>(exceptionApiDto,HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(UserHasNonePostException.class)
    public  ResponseEntity<ResponseApiDto> catchUserHasNonePostException(UserHasNonePostException e){
        ResponseApiDto exceptionApiDto = new ResponseApiDto(e.getMessage());
        return  new ResponseEntity<>(exceptionApiDto,HttpStatus.BAD_REQUEST);
    }
