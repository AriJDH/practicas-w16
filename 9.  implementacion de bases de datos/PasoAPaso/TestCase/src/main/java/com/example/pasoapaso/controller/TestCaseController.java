...
public class TestCaseController {
    ...
    public ResponseEntity<String> createJewerly(@RequestBody TestCase testCase){
        ...
        return new ResponseEntity<>("El testCase fue agregado correctamente.", HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<String> deleteTestCase(@PathVariable long id){
        ...
        return new ResponseEntity<>("El testCasea fue eliminado correctamente.", HttpStatus.OK);
    }
