package com.example.spring.qatesters.controller;

import com.example.spring.qatesters.model.TestCase;
import com.example.spring.qatesters.service.ITestCaseService;
...
public class TestCaseController {
    ...
    @PostMapping("/new")
    public ResponseEntity<String> createTest(@RequestBody TestCase testCase){
        testCaseService.saveTestCase(testCase);
        return new ResponseEntity<>("TestCase agregado correctamente.", HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<String> deleteTestCase(@PathVariable long id){
        ...
        return new ResponseEntity<>("TestCase eliminado correctamente.", HttpStatus.OK);
    }
