...
public class VehiculoController {
    ...
    @GetMapping("/vehiculos-siniestro")
    public ResponseEntity<?> getVehiculosSiniestros() {
        return new ResponseEntity<>(vehiculoService.getVehiculosSiniestro(), HttpStatus.OK);
    }

    @GetMapping("/vehiculos-siniestro-total")
    public ResponseEntity<?> getVehiculosSiniestrosTotal() {
        return new ResponseEntity<>(vehiculoService.getVehiculosSiniestroTotalPerdida(), HttpStatus.OK);
    }
}
