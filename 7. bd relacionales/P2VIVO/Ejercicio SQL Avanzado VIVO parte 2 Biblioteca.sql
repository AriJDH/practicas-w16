...
SELECT * FROM autor WHERE nacionalidad IN ('Brasileño', 'Colombiano');

# ¿Qué libros no son del área de internet?
SELECT * FROM libro l WHERE NOT l.larea = 'Internet';

# Listar los libros de la editorial Salamandra.
SELECT * FROM libro l WHERE l.editorial = 'Frankkaster';
