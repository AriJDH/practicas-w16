CREATE DATABASE  IF NOT EXISTS `movies_v3_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `movies_v3_db`;
-- MySQL dump 10.13  Distrib 8.0.30, for macos12 (x86_64)
--
-- Host: 127.0.0.1    Database: movies_v3_db
-- ------------------------------------------------------
...
-- Dump completed on 2022-08-28 17:35:44
