...
SELECT MAX(precio) as MaxPrecio FROM Planes;
SELECT dni,nombre,apellido, planes_idPlan FROM Clientes WHERE fecha_nacimiento LIKE '1993%'
ORDER BY Planes_idPlan ASC;