...
public class Util {
    public static Personaje parsePersonObject(JSONObject object){
        ...
        personaje.setEye_color((String) object.get("eye_color"));
        personaje.setGender((String) object.get("gender"));
        personaje.setBirth_year((String) object.get("birth_year"));
        ...
        personaje.setSkin_color((String) object.get("skin_color"));
        personaje.setSpecies((String) object.get("species"));
        personaje.setName((String) object.get("name"));
        personaje.setHair_color((String) object.get("hair_color"));
        return personaje;
    }
