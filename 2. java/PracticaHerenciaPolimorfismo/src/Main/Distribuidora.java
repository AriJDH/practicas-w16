...
public class Distribuidora {
    ...
    public static void main(String[] args) {
        ...
        productos.add(new Perecedero("producto1",10,10));
        productos.add(new Perecedero("producto2",23,10));
        productos.add(new Perecedero("producto3",50,15));
        productos.add(new Perecedero("producto4",10,4));
        productos.add(new Perecedero("producto5",10,5));
