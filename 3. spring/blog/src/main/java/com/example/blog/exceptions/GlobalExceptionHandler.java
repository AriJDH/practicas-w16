...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<EntradaNotFoundDTO> handlerException (RuntimeException exception ) {
        EntradaNotFoundDTO errorDTO = new EntradaNotFoundDTO("ERROR", exception.getMessage());
        return new ResponseEntity<>(errorDTO, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(HttpMessageNotReadableException.class)
    ResponseEntity<EntradaNotFoundDTO> notReadableException ( HttpMessageNotReadableException exception ) {
        EntradaNotFoundDTO errorDTO = new EntradaNotFoundDTO("HttpMessageNotReadableException", exception.getMessage());
    ...
    ResponseEntity<EntradaNotFoundDTO> validationsException ( MethodArgumentNotValidException exception ) {
        HashMap<String, List<String>> errors = getHashMapErrors(exception.getFieldErrors());

        EntradaNotFoundDTO errorDTO = new EntradaNotFoundDTO("Some Input are Invalids", errors);
        return new ResponseEntity<>(errorDTO, HttpStatus.BAD_REQUEST);
    }
