...
import com.bootcamp.application.services.RomanizarService;
...
public class RomanizarController {
    ...
    public String romanizar(@PathVariable Integer numero) {
        return "<head>" +
                ...
                "    <div class=\"splash\">\n" +
                "        <h1 class=\"splash-head\">Romanizar:</h1>\n" +
                "        <p class=\"splash-subhead\">\n" +
                String.format("La forma romana para el número <code>%s</code> es: %s.\n", numero, romanizarService.romanizar(numero)) +
                "        </p>\n" +
                "    </div>\n" +
                "</div>" +
                "</body>";
