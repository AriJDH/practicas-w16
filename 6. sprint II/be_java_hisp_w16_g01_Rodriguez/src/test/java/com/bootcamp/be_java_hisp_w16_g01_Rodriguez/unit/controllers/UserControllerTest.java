package com.bootcamp.be_java_hisp_w16_g01_Rodriguez.unit.controllers;

import com.bootcamp.be_java_hisp_w16_g01_Rodriguez.controller.UserController;
...
import com.bootcamp.be_java_hisp_w16_g01_Rodriguez.dto.response.UserUnfollowDTO;
import com.bootcamp.be_java_hisp_w16_g01_Rodriguez.service.IUserService;
import com.bootcamp.be_java_hisp_w16_g01_Rodriguez.utils.FactoryUser;
...
public class UserControllerTest {
    ...
    public void rightCantFollowersTest() {
        ...
        //Assert
        assertEquals(mockFollowersCount.getUserId(),result.getBody().getUserId());
        assertEquals(mockFollowersCount.getUserName(),result.getBody().getUserName());
