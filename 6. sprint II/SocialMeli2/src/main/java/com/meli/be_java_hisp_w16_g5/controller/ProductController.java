...
public class ProductController {
    ...
    public ResponseEntity<?> getFollowedProducts(@PathVariable Integer userId, @RequestParam Optional<String> order) throws UserNotFoundException, UnknownRequestException {
