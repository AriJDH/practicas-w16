...
public class UserIntegrationTest {
    ...
    @Test
    void unfollowControllerTestNullIntegration() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.post("/users/{userId}/unfollow/{userIdToUnfollow}",1,4690))
                .andDo(print())
                .andExpect(status().isBadRequest());
    }
