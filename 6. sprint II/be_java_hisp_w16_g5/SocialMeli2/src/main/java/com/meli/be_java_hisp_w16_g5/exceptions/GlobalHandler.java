...
public class GlobalHandler {
    ...
    public ResponseEntity<ExceptionDto> catchMethodArgumentNotValidException(MethodArgumentNotValidException b){

        ExceptionDto bu = new ExceptionDto(b.getBindingResult().getFieldError().getDefaultMessage());
        return new ResponseEntity<>(bu, HttpStatus.BAD_REQUEST);
    }
}
