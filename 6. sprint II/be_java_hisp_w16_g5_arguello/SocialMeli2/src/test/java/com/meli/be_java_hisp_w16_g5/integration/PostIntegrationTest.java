...
public class PostIntegrationTest {
    ...
    public void setUp() {
        ...
        this.postRepository.savePostPromo(new Post(1, 1, hoy, new Product(1, "Silla Gamer", "Gamer", "Racer", "Red y Black", "Special Edition"), 100, 1500.5, true, 0.25));
    }
    ...
    @Test
    public void getPromoPostCount() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get("/products/promo-post/count",1)
                        .param("user_id","1"))
                .andDo(print()).andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.user_id").value(1))
                .andExpect(MockMvcResultMatchers.jsonPath("$.user_name").value("Gae"))
