...
public interface IPostService {
    ...
    PostsByUserDto getFollowedProducts(Integer userId, String order) throws UserNotFoundException, UnknownRequestException;

    PostCountDto getPromoPostCount(int userId) throws UserNotFoundException;
