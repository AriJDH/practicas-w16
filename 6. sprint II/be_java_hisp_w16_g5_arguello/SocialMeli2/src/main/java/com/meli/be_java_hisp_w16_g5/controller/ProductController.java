...
public class ProductController {
     ...
     */
    @PostMapping("/post")
    public ResponseEntity<PostDto> savePost(@RequestBody @Valid Post post) throws UserNotFoundException, ProducNotFoundException {
    ...
    public ResponseEntity<PostsByUserDto> getFollowedProducts(@PathVariable Integer userId, @RequestParam Optional<String> order) throws UserNotFoundException, UnknownRequestException {
