...
public class UserRepository implements IUserRepository {
    ...
    public UserRepository() {
        ...
        User u2 = new User(2222, "Alexander The Great", new ArrayList<>(), new ArrayList<>(), List.of(new Post(2222, 1234, LocalDate.now(), new Product(123, "Phone", "Tech", "Apple", "Blue", "note"), 99, 1001.0, false, 0.0 )));
