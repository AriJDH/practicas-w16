...
public class FactoryPost {
    ...
    public static PostDto generatePostDTO(){
        ProductDto product = new ProductDto(111, "Silla Gamer", "Silla", "Racer", "Green", "notas" );
        return new PostDto(1, LocalDate.now(), product, 1, 2500D);
    }

    public static PostDto generateInvalidPostDTO(){
        ProductDto product = new ProductDto(-1, "Silla Gamer", "Silla", "Racer", "Green", "notas" );
        return new PostDto(1, LocalDate.now(), product, 1, 2500D);
    }
}
